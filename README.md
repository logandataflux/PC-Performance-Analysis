...
Workflow
Collected CPU and GPU telemetry under:
Idle
Gaming
Stress conditions
Cleaned and standardized raw hardware logs
Handled non-standard GPU log formats (.hml)
Processed datasets using Pandas
Visualized thermal and performance behavior using Matplotlib
Key Insights
...
GPU temperature comparison graph
Skills Demonstrated
